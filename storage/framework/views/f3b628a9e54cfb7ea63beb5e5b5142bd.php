...
<body>
    ...
    <table class="fields">
        ...
        <tr>
            <td class="label">Jumlah Angsuran</td><td class="colon">:</td><td>Rp <?php echo e(number_format($pinjaman->jumlah_angsuran, 0, ',', '.')); ?> / bulan</td>
        </tr>
        <tr>
    ...
    <table class="ttd" style="width: 100%;">
        <tr>
            <td style="width: 50%; text-align: center; vertical-align: top;">
                ...
                <?php if($pinjaman->nama_juru_bayar): ?>
                    <span class="ttd-name"><?php echo e($pinjaman->nama_juru_bayar); ?></span><br>
                <?php else: ?>
                    <span class="ttd-name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br>
                <?php endif; ?>
                NRP. <?php echo e($pinjaman->nrp_juru_bayar ?: ''); ?>
