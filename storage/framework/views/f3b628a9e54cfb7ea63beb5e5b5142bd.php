...
<head>
    <meta charset="UTF-8">
    <title>Formulir Pinjaman - <?php echo e($pinjaman->user->name); ?></title>
    <style>
...
<body>
    ...
    <table class="header-table">
        <tr>
            <td class="logo-cell">
                <img src="<?php echo e($logoKoperasi); ?>" alt="Logo Koperasi">
            </td>
            <td class="title-cell">
            ...
            <td class="logo-cell right">
                <img src="<?php echo e($logoKemhan); ?>" alt="Logo Kemhan">
            </td>
        </tr>
    </table>
    <hr class="divider">
    ...
    <table class="fields">
        <tr>
            <td class="label">Nama</td><td class="colon">:</td><td><?php echo e($pinjaman->user->name); ?></td>
        </tr>
        <tr>
            <td class="label">Pangkat/Gol/NRP/NIP</td><td class="colon">:</td><td><?php echo e($pangkatNrp ?: '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Jabatan/Satker</td><td class="colon">:</td><td><?php echo e($pinjaman->user->jabatan_satker ?: '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Nomor Rekening</td><td class="colon">:</td><td><?php echo e($pinjaman->no_rekening); ?></td>
        </tr>
        <tr>
            <td class="label">Nama Rekening</td><td class="colon">:</td><td><?php echo e($pinjaman->nama_rekening); ?></td>
        </tr>
    </table>
    ...
    <table class="fields">
        <tr>
            <td class="label">Nama Bank</td><td class="colon">:</td><td><?php echo e($pinjaman->nama_bank); ?></td>
        </tr>
        <tr>
            <td class="label">No. Handphone</td><td class="colon">:</td><td><?php echo e($pinjaman->no_hp ?: '-'); ?></td>
        </tr>
    </table>
    ...
    <table class="fields">
        <tr>
            <td class="label">Jumlah Pinjaman</td><td class="colon">:</td><td>Rp <?php echo e(number_format($pinjaman->jumlah_pinjaman, 0, ',', '.')); ?></td>
        </tr>
        <tr>
            <td class="label">Jumlah Angsuran</td><td class="colon">:</td><td><?php echo e($pinjaman->jumlah_angsuran ? 'Rp '.number_format($pinjaman->jumlah_angsuran, 0, ',', '.').' / bulan' : '(belum ditentukan)'); ?></td>
        </tr>
        <tr>
            <td class="label">Jangka Waktu Pinjaman</td><td class="colon">:</td><td><?php echo e($pinjaman->jangka_waktu); ?></td>
        </tr>
    </table>

    <p>
        Saya
        <span style="<?php echo e(!$pinjaman->punya_hutang_bank ? 'text-decoration: line-through;' : 'font-weight: bold;'); ?>">memiliki</span>
        /
        <span style="<?php echo e($pinjaman->punya_hutang_bank ? 'text-decoration: line-through;' : 'font-weight: bold;'); ?>">tidak memiliki</span>
        Hutang pada Bank
        <?php echo e($pinjaman->punya_hutang_bank ? ' '.$pinjaman->hutang_bank_nama.' ' : ' ______________________ '); ?>

        dengan angsuran
        Rp <?php echo e($pinjaman->punya_hutang_bank ? number_format($pinjaman->hutang_bank_angsuran, 0, ',', '.') : '______________'); ?> /bulan.
    </p>
    ...
    <table class="ttd" style="width: 100%;">
        <tr>
            <td style="width: 50%; text-align: center; vertical-align: top;">
                ...
                <?php if($namaJuruBayar): ?>
                    <span class="ttd-name"><?php echo e($namaJuruBayar); ?></span><br>
                <?php else: ?>
                    <span class="ttd-name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br>
                <?php endif; ?>
                NRP. <?php echo e($nrpJuruBayar ?: ''); ?>

            </td>
            <td style="width: 50%; text-align: center; vertical-align: top;">
                Jakarta, <?php echo e(($pinjaman->processed_at ?? $pinjaman->created_at)->translatedFormat('d - m - Y')); ?><br>
                Pemohon,
                <div class="ttd-space"></div>
                <span class="ttd-name"><?php echo e($pinjaman->user->name); ?></span><br>
                NIP/NRP. <?php echo e($pinjaman->user->nip_nrp); ?>
...
</html><?php /**PATH C:\Users\meyra\OneDrive\Dokumen\KEMHAN TERBARU\Sistem-Pinjam-main\Sistem-Pinjam-main\resources\views/anggota/pinjaman/pdf.blade.php ENDPATH**/ ?>